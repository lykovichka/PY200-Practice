...
if __name__ == "__main__":
    ...
    glass2 = Glass(500,150)  # TODO инициализировать ещё один стакан
    ...
    glass1.occupied_volume += 50#  TODO доливаем воды в первый стакан
    print(glass1.capacity_volume, glass1.occupied_volume)
    print(glass2.capacity_volume, glass2.occupied_volume)

    print(id(glass1), id(glass2))#  TODO сравнить id объектов
